...
const Index = () => {
  ...
  const featuredWriters = writers.slice(0, 10);
      ...
      <main className="flex-1">
        ...
        <div className="container px-4 py-16 mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl mx-auto mb-16">
            {featuredWriters.slice(0, 6).map((writer) => (
              <div
                key={writer.id}
                className="group relative overflow-hidden rounded-xl bg-white p-6 shadow-md transition-all duration-300 hover:shadow-xl hover:-translate-y-1 hover:scale-[1.02]"
              >
